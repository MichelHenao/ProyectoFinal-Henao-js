 ...
 function register() {
   ...
   function login() {
    ...
    if (password == storedPassword) {
      ...
      // Ocultar la sección de registro y login
      hideRegisterLoginSection();
  ...
  function hideRegisterLoginSection() {
    var section = document.getElementById("registro-login");
 ...
 function onLogin() {
  ...
  function login() {
   ...
   searchBox.addEventListener('input', function() {
     ...
     // Iterar por cada producto y ocultar aquellos que no coincidan con el término de búsqueda
     for (let i = 0; i < products.length; i++) {
       const title = products[i].querySelector('.item-title').textContent.toLowerCase();
       const description = products[i].querySelector('p').textContent.toLowerCase();
   ...
   // Agregar evento para mostrar todos los productos cuando se borre el término de búsqueda
